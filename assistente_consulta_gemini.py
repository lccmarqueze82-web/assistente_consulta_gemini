...
# Prompt para a Etapa 2 (PEC1) - ESTRUTURAÇÃO PARA TEXTO SIMPLES DO PEC (AGORA PERFEITO)
# LÓGICA: Configurado para: Título: <Seção>:, Conteúdo: linha(s) abaixo. Linha vazia: OBRIGATÓRIA entre seções.
SYSTEM_ROLE_PEC1 = r"""
...
if st.session_state.get("show_manual_copy"):
    if caixa2_has_content:
        ...
        st.info("💡 **Dica:** O texto abaixo está no formato **Texto Simples** exigido pelo PEC, com os títulos das seções em linhas separadas e uma linha vazia entre as seções. Use o botão **'Copy' (dois quadrados)** para garantir que as quebras de linha sejam copiadas corretamente.")
