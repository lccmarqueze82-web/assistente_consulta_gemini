...
# CORREÇÃO: Adicionado o prefixo 'r' para criar uma 'raw string' e evitar o erro com '\N'
SYSTEM_ROLE_PEC1 = r"""
...
if st.session_state.get("show_manual_copy"):
    if caixa2_has_content:
        ...
        st.info("💡 **Dica:** O texto abaixo está no formato **Texto Simples** exigido pelo PEC. Use o botão **'Copy' (dois quadrados)** para garantir que as quebras de linha sejam copiadas corretamente.")
